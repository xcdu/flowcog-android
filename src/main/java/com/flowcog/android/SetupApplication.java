...
import com.flowcog.android.callbacks.AbstractCallbackAnalyzer;
import com.flowcog.android.callbacks.CallbackDefinition;
import com.flowcog.android.callbacks.CallbackDefinition.CallbackType;
import com.flowcog.android.callbacks.DefaultCallbackAnalyzer;
import com.flowcog.android.callbacks.FastCallbackAnalyzer;
import com.flowcog.android.callbacks.filters.AlienFragmentFilter;
import com.flowcog.android.callbacks.filters.AlienHostComponentFilter;
import com.flowcog.android.callbacks.filters.ApplicationCallbackFilter;
import com.flowcog.android.config.SootConfigForAndroid;
import com.flowcog.android.data.AndroidMemoryManager;
import com.flowcog.android.data.AndroidMethod;
import com.flowcog.android.data.parsers.PermissionMethodParser;
import com.flowcog.android.iccta.IccInstrumenter;
import com.flowcog.android.iccta.IccResults;
import com.flowcog.android.iccta.MessengerInstrumenter;
import com.flowcog.android.manifest.ProcessManifest;
import com.flowcog.android.resources.ARSCFileParser;
import com.flowcog.android.resources.ARSCFileParser.AbstractResource;
import com.flowcog.android.resources.ARSCFileParser.StringResource;
import com.flowcog.android.resources.LayoutControl;
import com.flowcog.android.resources.LayoutFileParser;
import com.flowcog.android.source.AccessPathBasedSourceSinkManager;
import com.flowcog.android.source.parsers.xml.XMLSourceSinkParser;
...
public class SetupApplication {
	...
	private String getClasspath() {
		String classpath = forceAndroidJar ? androidJar : Scene
      .v().getAndroidJarPath(androidJar, apkFileLocation);
