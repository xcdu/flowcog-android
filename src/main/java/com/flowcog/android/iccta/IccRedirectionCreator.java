 package com.flowcog.android.iccta;
 ...
 public class IccRedirectionCreator {
     ...
     public SootMethod generateRedirectMethodForStartActivityForResult(SootClass originActivity, SootClass destComp)
     {
       String newSM_name = "redirector" + num++;
         ...
         invoke = Jimple
           .v().newVirtualInvokeExpr(originActivityParameterLocal, method.makeRef(), args);
     ...
     public SootMethod generateRedirectMethodForBindService(
       SootClass serviceConnection, SootClass destComp)
     {
       String newSM_name = "redirector" + num++;
         ...
         {
           invoke = Jimple
             .v().newInterfaceInvokeExpr(originActivityParameterLocal, method.makeRef(), args);
         }
         else
         {
           invoke = Jimple
     ...
     public SootMethod generateFakeOnActivityResult(SootClass sootClass)
     {
       ...
       parameters.add(INTENT_TYPE);
         ...
         Unit int1ParameterU = Jimple
           .v().newIdentityStmt(int1ParameterLocal, Jimple.v().newParameterRef(IntType.v(), 0));

         //parameter2
         Local int2ParameterLocal = lg.generateLocal(IntType.v());
         Unit int2ParameterU = Jimple
           .v().newIdentityStmt(int2ParameterLocal, Jimple.v().newParameterRef(IntType.v(), 1));
         ...
         Unit intentParameterU = Jimple
           .v().newIdentityStmt(intentParameterLocal, Jimple.v().newParameterRef(intentType, 2));
