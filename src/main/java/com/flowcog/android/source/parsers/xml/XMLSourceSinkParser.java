package com.flowcog.android.source.parsers.xml;

import com.flowcog.android.data.AndroidMethod;
import com.flowcog.android.data.AndroidMethod.CATEGORY;
import java.io.File;
      ...
      SourceSinkDefinition ssd = new SourceSinkDefinition(tempMeth, baseAPs,
		...
		case XMLConstants.ACCESSPATH_TAG:
			...
			if (isSource || isSink) {
				...
				AccessPathTuple apt = AccessPathTuple
          .fromPathElements(pathElements, pathElementTypes, isSource,
						isSink);
